...
export const deployment = {
  application: 'partageonsleau-orchestration',
  projectId: '8b2f67a8-b474-4596-967f-fe1e0adba1b3',
  organizationId: 'aae4422f-c198-4638-b9e5-977938791f14',
  targets: {
    testing: {containerId: 'fa7450e3-06a4-4f0c-a824-2624eb1d8be7', containerName: 'testing-orchestration', namespaceId: 'bfb37e50-4bd4-42dc-94ca-2064f8b46898'},
    demo: {containerId: '6ae600a8-979e-4469-9512-6856c4e6edb5', containerName: 'demo-orchestration', namespaceId: 'c90182ec-fb81-4fca-ad36-0e37ce351466'},
    prod: {containerId: '0765eab2-269a-4ec6-8cf3-23a8b3a59bea', containerName: 'prod-orchestration', namespaceId: 'fa4179ac-8658-4440-963b-66d669a452d5'}
  }
}
